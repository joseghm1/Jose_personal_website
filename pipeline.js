...
function drawPipe(x, y, life, ttl, width, hue) {
  ctx.a.save();
  ctx.a.strokeStyle = `hsla(${hue},75%,50%,${fadeInOut(life, ttl) * 0.2})`;
  ctx.a.beginPath();
...
function createCanvas() {
  container = document.querySelector('.content--canvasPipeline');
  canvas = {
...
function render() {
  ...
  ctx.b.clearRect(0, 0, canvas.a.width, canvas.a.height);  // Clear instead of fill
