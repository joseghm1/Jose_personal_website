...
const yOff = 0.0015;
const zOff = 0.0015;
const backgroundColor = 'rgb(10, 30, 35)';
...
function drawRay(x, y1, y2, life, ttl, width, hue) {
  ...
  gradient.addColorStop(0, `hsla(${hue},84%,57%,0)`);
  gradient.addColorStop(0.5, `hsla(${hue},84%,57%,${fadeInOut(life, ttl) * 0.15})`);
  gradient.addColorStop(1, `hsla(${hue},84%,57%,0)`);
